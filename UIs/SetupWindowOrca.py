...
class Ui_SetupWindow(object):
    def setupUi(self, SetupWindow):
        ...
        self.gridLayout_8.addLayout(self.horizontalLayout_6, 6, 1, 1, 1)
        ...
        self.gridLayout_8.addLayout(self.verticalLayout_11, 7, 1, 1, 1)
        ...
        self.pushButton_add_carbons_hydrogens_freeze = QtWidgets.QPushButton(
            self.tab_freeze
        )
        self.pushButton_add_carbons_hydrogens_freeze.setObjectName(
            "pushButton_add_carbons_hydrogens_freeze"
        )
        self.gridLayout_8.addWidget(
            self.pushButton_add_carbons_hydrogens_freeze, 3, 1, 1, 1
        )
    ...
    def retranslateUi(self, SetupWindow):
        ...
        self.pushButton_add_carbons_freeze.setText(
            _translate("SetupWindow", "Add all alpha-carbons to list")
        )
        self.pushButton_add_carbons_hydrogens_freeze.setText(
            _translate(
                "SetupWindow", "Add all alpha-carbons and alpha-hydrogens to list"
            )
        )
        self.tabWidget.setTabText(
