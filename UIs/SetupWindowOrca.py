...
"}")
        ...
        self.pushButton_add_carbons_hydrogens_freeze = QtWidgets.QPushButton(self.tab_freeze)
        self.pushButton_add_carbons_hydrogens_freeze.setObjectName("pushButton_add_carbons_hydrogens_freeze")
        self.gridLayout_8.addWidget(self.pushButton_add_carbons_hydrogens_freeze, 3, 1, 1, 1)
    ...
    def retranslateUi(self, SetupWindow):
        ...
        self.pushButton_add_carbons_freeze.setText(_translate("SetupWindow", "Add all alpha-carbons to list"))
        self.pushButton_add_carbons_hydrogens_freeze.setText(_translate("SetupWindow", "Add all alpha-carbons and alpha-hydrogens to list"))
