...
class Ui_ClusterPDB(object):
    def setupUi(self, ClusterPDB):
        ...
        self.pushButton = QtWidgets.QPushButton(self.validate)
        ...
        self.gridLayout_11.addItem(spacerItem6, 0, 0, 1, 1)
    ...
    def retranslateUi(self, ClusterPDB):
        ...
        self.pushButton.setText(_translate("ClusterPDB", "Add missing hydrogen to model"))
        self.label_9.setText(_translate("ClusterPDB", "or add capping (requires no missing hydrogens in protein backbone)"))
