...
# Form implementation generated from reading ui file 'UIs/SetupWindow.ui'
#
...
class Ui_SetupWindow(object):
    def setupUi(self, SetupWindow):
        ...
        self.label_software = QtWidgets.QLabel(self.scrollAreaWidgetContents_2)
        self.label_software.setObjectName("label_software")
        self.horizontalLayout_9.addWidget(self.label_software)
        ...
        self.horizontalLayout_9.addWidget(self.radioButton_gaussian)
        self.radioButton_orca = QtWidgets.QRadioButton(self.scrollAreaWidgetContents_2)
        self.radioButton_orca.setObjectName("radioButton_orca")
        self.horizontalLayout_9.addWidget(self.radioButton_orca)
        ...
        self.widget_gaussian_options = QtWidgets.QWidget(
            self.scrollAreaWidgetContents_2
        )
        self.widget_gaussian_options.setObjectName("widget_gaussian_options")
        self.verticalLayout_gaussian = QtWidgets.QVBoxLayout(
            self.widget_gaussian_options
        )
        self.verticalLayout_gaussian.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_gaussian.setObjectName("verticalLayout_gaussian")
        self.label_gaussian_link0 = QtWidgets.QLabel(self.widget_gaussian_options)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.label_gaussian_link0.setFont(font)
        self.label_gaussian_link0.setObjectName("label_gaussian_link0")
        self.verticalLayout_gaussian.addWidget(self.label_gaussian_link0)
        self.gridLayout_9 = QtWidgets.QGridLayout()
        self.gridLayout_9.setObjectName("gridLayout_9")
        self.checkBox_mem_2 = QtWidgets.QCheckBox(self.widget_gaussian_options)
        ...
        self.Button_add_link0 = QtWidgets.QPushButton(self.widget_gaussian_options)
        ...
        self.Button_del_link0 = QtWidgets.QPushButton(self.widget_gaussian_options)
        ...
        self.LineEdit_link0 = QtWidgets.QLineEdit(self.widget_gaussian_options)
        ...
        self.additional_job_4 = QtWidgets.QLabel(self.widget_gaussian_options)
        ...
        self.list_link0 = QtWidgets.QListWidget(self.widget_gaussian_options)
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding
        )
        sizePolicy.setHorizontalStretch(0)
        ...
        self.checkBox_chk = QtWidgets.QCheckBox(self.widget_gaussian_options)
        ...
        self.lineEdit_chk = QtWidgets.QLineEdit(self.widget_gaussian_options)
        self.lineEdit_chk.setObjectName("lineEdit_chk")
        self.gridLayout_9.addWidget(self.lineEdit_chk, 1, 1, 1, 1)
        self.checkBox_oldchk = QtWidgets.QCheckBox(self.widget_gaussian_options)
        ...
        self.lineEdit_oldchk = QtWidgets.QLineEdit(self.widget_gaussian_options)
        ...
        self.lineEdit_mem_2 = QtWidgets.QLineEdit(self.widget_gaussian_options)
        self.lineEdit_mem_2.setObjectName("lineEdit_mem_2")
        self.gridLayout_9.addWidget(self.lineEdit_mem_2, 0, 1, 1, 1)
        self.verticalLayout_gaussian.addLayout(self.gridLayout_9)
        self.verticalLayout_4.addWidget(self.widget_gaussian_options)
        self.widget_orca_options = QtWidgets.QWidget(self.scrollAreaWidgetContents_2)
        self.widget_orca_options.setObjectName("widget_orca_options")
        self.verticalLayout_orca = QtWidgets.QVBoxLayout(self.widget_orca_options)
        self.verticalLayout_orca.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_orca.setObjectName("verticalLayout_orca")
        self.label_orca_parallel = QtWidgets.QLabel(self.widget_orca_options)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.label_orca_parallel.setFont(font)
        self.label_orca_parallel.setObjectName("label_orca_parallel")
        self.verticalLayout_orca.addWidget(self.label_orca_parallel)
        self.gridLayout_orca = QtWidgets.QGridLayout()
        self.gridLayout_orca.setObjectName("gridLayout_orca")
        self.label_orca_nprocs = QtWidgets.QLabel(self.widget_orca_options)
        self.label_orca_nprocs.setObjectName("label_orca_nprocs")
        self.gridLayout_orca.addWidget(self.label_orca_nprocs, 0, 0, 1, 1)
        self.spinBox_orca_nprocs = QtWidgets.QSpinBox(self.widget_orca_options)
        self.spinBox_orca_nprocs.setMinimum(1)
        self.spinBox_orca_nprocs.setMaximum(128)
        self.spinBox_orca_nprocs.setProperty("value", 4)
        self.spinBox_orca_nprocs.setObjectName("spinBox_orca_nprocs")
        self.gridLayout_orca.addWidget(self.spinBox_orca_nprocs, 0, 1, 1, 1)
        self.label_orca_maxcore = QtWidgets.QLabel(self.widget_orca_options)
        self.label_orca_maxcore.setObjectName("label_orca_maxcore")
        self.gridLayout_orca.addWidget(self.label_orca_maxcore, 1, 0, 1, 1)
        self.spinBox_orca_maxcore = QtWidgets.QSpinBox(self.widget_orca_options)
        self.spinBox_orca_maxcore.setMinimum(100)
        self.spinBox_orca_maxcore.setMaximum(100000)
        self.spinBox_orca_maxcore.setSingleStep(100)
        self.spinBox_orca_maxcore.setProperty("value", 2000)
        self.spinBox_orca_maxcore.setObjectName("spinBox_orca_maxcore")
        self.gridLayout_orca.addWidget(self.spinBox_orca_maxcore, 1, 1, 1, 1)
        spacerItem9 = QtWidgets.QSpacerItem(
            40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum
        )
        self.gridLayout_orca.addItem(spacerItem9, 0, 2, 2, 1)
        self.verticalLayout_orca.addLayout(self.gridLayout_orca)
        self.verticalLayout_4.addWidget(self.widget_orca_options)
    ...
    def retranslateUi(self, SetupWindow):
        ...
        self.label_software.setText(_translate("SetupWindow", "Software:"))
        self.radioButton_gaussian.setText(_translate("SetupWindow", "Gaussian"))
        self.radioButton_orca.setText(_translate("SetupWindow", "ORCA"))
        ...
        self.label_gaussian_link0.setText(
            _translate("SetupWindow", "Gaussian Link0 Options")
        )
        ...
        self.label_orca_parallel.setText(
            _translate("SetupWindow", "ORCA Parallel Options")
        )
        self.label_orca_nprocs.setText(
            _translate("SetupWindow", "Number of processors (nprocs):")
        )
        self.label_orca_maxcore.setText(
            _translate("SetupWindow", "Memory per core (MB):")
        )
