...
"")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 940, 805))
...
"")
        ...
        self.gridLayout_3 = QtWidgets.QGridLayout(self.tab_freeze)
        ...
        self.comboBox_freezetype.addItem("")
        self.comboBox_freezetype.addItem("")
        self.gridLayout_3.addWidget(self.comboBox_freezetype, 0, 0, 1, 1)
        self.button_auto_freeze = QtWidgets.QPushButton(self.tab_freeze)
        self.button_auto_freeze.setObjectName("button_auto_freeze")
        self.gridLayout_3.addWidget(self.button_auto_freeze, 0, 1, 1, 1)
...
"}")
        ...
        self.gridLayout_3.addLayout(self.verticalLayout_7, 1, 3, 1, 1)
        self.tabWidget.addTab(self.tab_freeze, "")
        self.tab_scan = QtWidgets.QWidget()
        self.tab_scan.setObjectName("tab_scan")
        self.gridLayout_19 = QtWidgets.QGridLayout(self.tab_scan)
        self.gridLayout_19.setObjectName("gridLayout_19")
        self.label_13 = QtWidgets.QLabel(self.tab_scan)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.label_13.setFont(font)
        self.label_13.setObjectName("label_13")
        self.gridLayout_19.addWidget(self.label_13, 0, 0, 1, 2)
        spacerItem15 = QtWidgets.QSpacerItem(260, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_19.addItem(spacerItem15, 0, 2, 1, 1)
        self.label_18 = QtWidgets.QLabel(self.tab_scan)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        spacerItem16 = QtWidgets.QSpacerItem(259, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_19.addItem(spacerItem16, 0, 4, 1, 1)
        self.list_model_scan = QtWidgets.QListWidget(self.tab_scan)
        self.list_model_scan.setMinimumSize(QtCore.QSize(300, 0))
        font = QtGui.QFont()
        font.setFamily("Courier")
        font.setPointSize(11)
        self.list_model_scan.setFont(font)
        self.list_model_scan.setStyleSheet("border 2px solid rgb(143, 23, 119);\n"
"\n"
"")
        self.list_model_scan.setObjectName("list_model_scan")
        self.gridLayout_19.addWidget(self.list_model_scan, 1, 0, 2, 1)
        self.gridLayout_16 = QtWidgets.QGridLayout()
        self.gridLayout_16.setObjectName("gridLayout_16")
        self.spinbox_scan_increment = QtWidgets.QDoubleSpinBox(self.tab_scan)
        ...
        self.gridLayout_16.addWidget(self.spinbox_scan_increment, 1, 2, 1, 1)
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.radioButton_plus = QtWidgets.QRadioButton(self.tab_scan)
        self.radioButton_plus.setFocusPolicy(QtCore.Qt.NoFocus)
        self.radioButton_plus.setObjectName("radioButton_plus")
        self.horizontalLayout_5.addWidget(self.radioButton_plus)
        self.radioButton_minus = QtWidgets.QRadioButton(self.tab_scan)
        self.radioButton_minus.setFocusPolicy(QtCore.Qt.NoFocus)
        self.radioButton_minus.setObjectName("radioButton_minus")
        self.horizontalLayout_5.addWidget(self.radioButton_minus)
        self.radioButton_both = QtWidgets.QRadioButton(self.tab_scan)
        ...
        self.spinbox_scan_pm = QtWidgets.QDoubleSpinBox(self.tab_scan)
        ...
        self.gridLayout_16.addWidget(self.spinbox_scan_pm, 1, 1, 1, 1)
        self.label_14 = QtWidgets.QLabel(self.tab_scan)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_17 = QtWidgets.QLabel(self.tab_scan)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.spinbox_radius = QtWidgets.QDoubleSpinBox(self.tab_scan)
        self.spinbox_radius.setObjectName("spinbox_radius")
        self.gridLayout_16.addWidget(self.spinbox_radius, 1, 0, 1, 1)
        self.gridLayout_19.addLayout(self.gridLayout_16, 1, 2, 1, 3)
        self.gridLayout_17 = QtWidgets.QGridLayout()
        self.gridLayout_17.setObjectName("gridLayout_17")
        self.list_scan_bonds = QtWidgets.QListWidget(self.tab_scan)
        ...
        self.gridLayout_17.addWidget(self.list_scan_bonds, 0, 1, 4, 1)
        self.button_add_scan = QtWidgets.QPushButton(self.tab_scan)
...
"}")
        ...
        self.gridLayout_17.addWidget(self.button_add_scan, 1, 0, 1, 1)
        spacerItem17 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_17.addItem(spacerItem17, 0, 0, 1, 1)
        self.button_delete_scan = QtWidgets.QPushButton(self.tab_scan)
...
"}")
        ...
        self.gridLayout_17.addWidget(self.button_delete_scan, 2, 0, 1, 1)
        spacerItem18 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_17.addItem(spacerItem18, 3, 0, 1, 1)
        self.gridLayout_19.addLayout(self.gridLayout_17, 2, 1, 1, 4)
        self.gridLayout_18 = QtWidgets.QGridLayout()
        self.gridLayout_18.setObjectName("gridLayout_18")
        self.button_invert = QtWidgets.QPushButton(self.tab_scan)
        self.button_invert.setEnabled(True)
        self.button_invert.setObjectName("button_invert")
        self.gridLayout_18.addWidget(self.button_invert, 0, 1, 1, 1)
        self.checkBox_moveboth = QtWidgets.QCheckBox(self.tab_scan)
        self.checkBox_moveboth.setEnabled(True)
        self.checkBox_moveboth.setObjectName("checkBox_moveboth")
        self.gridLayout_18.addWidget(self.checkBox_moveboth, 0, 2, 1, 1)
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.label_19 = QtWidgets.QLabel(self.tab_scan)
        self.label_19.setObjectName("label_19")
        self.horizontalLayout_6.addWidget(self.label_19)
        self.lineEdit_freeze = QtWidgets.QLineEdit(self.tab_scan)
        ...
        self.horizontalLayout_6.addWidget(self.lineEdit_freeze)
        self.label_20 = QtWidgets.QLabel(self.tab_scan)
        self.label_20.setObjectName("label_20")
        self.horizontalLayout_6.addWidget(self.label_20)
        self.lineEdit_move = QtWidgets.QLineEdit(self.tab_scan)
        ...
        self.horizontalLayout_6.addWidget(self.lineEdit_move)
        self.gridLayout_18.addLayout(self.horizontalLayout_6, 0, 0, 1, 1)
        self.gridLayout_19.addLayout(self.gridLayout_18, 3, 1, 1, 4)
    ...
    def retranslateUi(self, SetupWindow):
        ...
        self.label_13.setText(_translate("SetupWindow", "Atoms in model"))
        self.label_18.setText(_translate("SetupWindow", "Scan (bond)"))
        ...
        self.label_14.setText(_translate("SetupWindow", "Increment"))
        self.label_17.setText(_translate("SetupWindow", "Current distance (Å)"))
        self.button_invert.setText(_translate("SetupWindow", "Invert"))
        self.checkBox_moveboth.setText(_translate("SetupWindow", "Move both"))
        self.label_19.setText(_translate("SetupWindow", "Freeze:"))
        self.label_20.setText(_translate("SetupWindow", "Move:"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_scan), _translate("SetupWindow", "Scan bond"))
